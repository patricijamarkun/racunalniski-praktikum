...
Magični kvadrat v litografiji Melancholia I (glej sliko \eqref{eq:numbers}
...
približno 250 let pred Dürerjevim časom. \ref{fig:durer}
...
\begin{figure}[!ht]
   \centering
   \caption{Slika 1: Dürerjev magični kvadrat}
...
\begin{figure}
   ...
   \includegraphics[scale=0.6]{sagrada.png}
\end{figure}
...
\begin{proof}
   ...
   enaka številu $\m(n)$. \eqref{eq:numbers, eq:numbers}
\end{proof}
...
sta za oceno uporabila simulacijo Monte Carlo in metode statistične mehanike.
 \cite{bessy, berlekamp, gardner, pinn}% ključi: bessy, berlekamp, gardner, pinn
