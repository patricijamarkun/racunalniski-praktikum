...
\begin{abstract}% začetek povzetka
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   \begin{enumerate}
	\item Z zanko se sprehodimo po vektorju vseh predmetov. Predmet na \( \text{i} \)-tem koraku
   označimo s \( \text{predavalnica}_j \).

   \item Naslednja vgnezdena zanka nas popelje po vseh predavalnicah. Predavalnico na
   \( \text{j} \)-tem koraku označimo s \( \text{predavalnica}_j \).
